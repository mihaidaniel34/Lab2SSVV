...
public class UI {
    ...
    private void adaugaStudent() throws ValidationException {
        ...
        String numeProf = scanner.next();
        Student student = new Student(idStudent, numeStudent, grupa, email, numeProf);
    ...
    private void updateStudent() {
        ...
        System.out.print("Introduceti numele profesorului: ");
        String numeProf = scanner.next();
        Student student = new Student(id, nume, grupa, email, numeProf);
